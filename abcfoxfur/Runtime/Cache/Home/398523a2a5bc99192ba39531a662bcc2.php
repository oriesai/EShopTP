...
<body>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
					<?php if(is_array($cartinfo)): $i = 0; $__LIST__ = $cartinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
							<td class="col1"><a href=""><img src="/Public/Uploads<?php echo ($v["thumb"]); ?>" alt="" /></a>  <strong><a href=""><?php echo ($v["goods_name"]); ?></a></strong></td>
							<td class="col3">￥<?php echo (sprintf( '%.2f',$v["goods_price"])); ?></td>
							<td class="col4"> <?php echo ($v["goods_buy_number"]); ?></td>
							<td class="col5"><span>￥<?php echo (sprintf( '%.2f',$v["goods_price"])); ?></span></td>
					...
					<tfoot>
						<tr>
							<td colspan="5">
								<ul>
									<li>
										<span><?php echo ($getNumberPrice["number"]); ?>件商品，总商品金额：</span>
										<em>￥<?php echo (sprintf( '%.2f',$getNumberPrice["price"])); ?></em>
									</li>
									<!--<li>-->
										<!--<span>返现：</span>-->
										<!--<em>-￥240.00</em>-->
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong>￥<?php echo (sprintf( '%.2f',$getNumberPrice["price"])); ?>元</strong></p>
