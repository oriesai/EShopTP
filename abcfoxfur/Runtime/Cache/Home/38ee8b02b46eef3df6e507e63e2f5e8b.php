...
<!--qq login plugin from example-->
<script type="text/javascript">
	   var childWindow;
            function toQzoneLogin()
            {
                //jump to qq() in controller
                childWindow = window.open("Member/qq","TencentLogin","width=450,height=320,menubar=0,scrollbars=1, resizable=1,status=1,titlebar=0,toolbar=0,location=1");
            }
		...
		<div class="login_bd">
			<div class="login_form fl">
				...
				<div class="coagent mt15">
					<dl>
						<dt>使用合作网站登录商城：</dt>
						<dd class="qq"><a href="<?php echo U('Member/qq');?>"><span></span>QQ</a></dd>
