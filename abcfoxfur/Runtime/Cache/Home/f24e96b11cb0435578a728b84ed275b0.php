...
<form action="" method="post" onsubmit="return submitForm(this)">
    ...
    vcode<input type="test" name="verify" id="captcha" placeholder="captcha">
	<p><img class='code' id="changeCode" src="<?php echo U('exam/genCode');?>" alt="" /></p>
				<button type="submit" id="login-button">Login</button>
</form>
</body>
</html>

<script src="/Public/Admin/js/jquery-2.1.1.2min.js" type="text/javascript"></script>

<script type="text/javascript">
function submitForm(obj){
	//add effect when success
    //verif form if empty and if captcha value is less then 4
    if(obj.name.value==''||obj.passwd.value==''||obj.captcha.value==''){
