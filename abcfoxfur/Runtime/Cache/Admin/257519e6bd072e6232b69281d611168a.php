    ...
    <div class="rightinfo">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($data['list'])): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><a href="<?php echo U('edit',array('type_id' =>$v['type_id']));?>" class="tablelink">修改&nbsp;</a><a href="<?php echo U('ProductAttributeCate/index',array('type_id' =>$v['type_id']));?>" class="tablelink">屬性列表</a><a href="<?php echo U('delete',array('type_id' =>$v['type_id']));?>" class="tablelink"> 删除</a></td>
