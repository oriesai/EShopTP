        ...
        <ul class="forminfo">
            <li>
                ...
                <input name="product_name" placeholder="请输入商品名称" type="text" class="dfinput"
                       value="<?php echo ($info["product_name"]); ?>"/><i>名称不能超过30个字符</i></li>
            <li>
                <label>product price</label>
                <input name="product_price" placeholder="请输入商品价格" type="text" class="dfinput"
                       value=<?php echo ($info["product_price"]); ?> /><i></i>
            </li>
            <li>
                <label>product quantity</label>
                <input name="product_number" placeholder="请输入商品数量" type="text" class="dfinput"
                       value=<?php echo ($info["product_number"]); ?> />
            </li>
            <li>
                <label>create time</label>
                <input id="update" name="created_time" placeholder="请输入添加時間" value="<?php echo (date('Y-m-d H:i:s',$info["created_time"])); ?>" type="text"
                       class="dfinput"/>
            </li>
            <li>
                <label>product weight</label>
                <input name="product_weight" type="text" class="dfinput" placeholder="请输入商品重量" value="50"
                       value=<?php echo ($info["product_weight"]); ?>/>
            </li>
            <li>
            ...
            <li><label>put on shelf?</label>
                <cite>
                    <input name="is_show" type="radio" value="1" <?php if($info['is_show'] == 1): ?>checked<?php endif; ?> />onshelf&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="is_show" type="radio" value="0" <?php if($info['is_show'] == 0): ?>checked<?php endif; ?> />offshelf
                </cite>
            </li>
        ...
        <ul class="forminfo">
            <li>
                ...
                <textarea name="product_desc" placeholder="请输入商品描述" id='product_desc' cols="" rows=""
                          class="textinput textinput2"><?php echo ($info["product_desc"]); ?></textarea>
            </li>
        </ul>
        <ul class="btn">
            <li>
                <input type="hidden" name='product_id' value="<?php echo ($info["product_id"]); ?>"/>
                <input type="hidden" name='product_big_logo' value="<?php echo ($info["product_big_logo"]); ?>"/>
                <input type="hidden" name='product_small_logo' value="<?php echo ($info["product_small_logo"]); ?>"/>
